...
_DIRS=$(PPRRD_OBJDIR) $(PPRRD_BINDIR)
...
eac.pprrd: lex.yy.c mkdirs $(PPRRD_OBJS)
	gcc lex.yy.c $(PPRRD_APP) -I ./ -I lib/ -I $(PPRRD_LIBDIR) -o $@

$(PPRRD_OBJDIR)/%.o : $(PPRRD_SRCDIR)/%.c
	gcc -c -I ./ -I lib/ -I $(PPRRD_LIBDIR) $< -o $@
